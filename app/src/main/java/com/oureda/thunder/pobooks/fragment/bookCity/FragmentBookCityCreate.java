...
public class FragmentBookCityCreate extends Fragment {
    @BindView(R.id.wait_create_city)
    WaitView waitCreateCity;
    @BindView(R.id.recycle_book_city_create)
    RecyclerView recycleBookCityCreate;
    Unbinder unbinder;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        waitCreateCity.start();
        HttpUtils.postAsyn(StringManager.URL + "createlist", new Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        initRecycleView();
                        waitCreateCity.stop();
                        waitCreateCity.setVisibility(View.GONE);
                    }
                });
    ...
    private void initRecycleView(){
        ...
        recycleBookCityCreate.setLayoutManager(manager);
...
//                                    TitleInfo localTitleInfo = new TitleInfo(SearchResultActivity.2.1.this.val$book_id, localData.getAddress().substring(localData.getAddress().lastIndexOf("/") + 1, localData.getAddress().lastIndexOf(".")));
        ...
        recycleBookCityCreate.setAdapter(adapter);
    }
}
