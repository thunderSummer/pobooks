...
public class FragmentBookCityNew extends Fragment {
    @BindView(R.id.wait_new_city)
    WaitView waitNewCity;
    @BindView(R.id.recycle_book_city_new)
    RecyclerView recycleBookCityNew;
    Unbinder unbinder;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        waitNewCity.start();
        HttpUtils.postAsyn(StringManager.URL + "newlist", new Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        initRecycleView();
                        waitNewCity.stop();
                        waitNewCity.setVisibility(View.GONE);
                    }
                });
    ...
    private void initRecycleView(){
        ...
        recycleBookCityNew.setLayoutManager(manager);
...
//                                    TitleInfo localTitleInfo = new TitleInfo(SearchResultActivity.2.1.this.val$book_id, localData.getAddress().substring(localData.getAddress().lastIndexOf("/") + 1, localData.getAddress().lastIndexOf(".")));
        ...
        recycleBookCityNew.setAdapter(adapter);
    }
    @Override
