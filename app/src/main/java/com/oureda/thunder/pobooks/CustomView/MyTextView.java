...
public class MyTextView extends android.support.v7.widget.AppCompatEditText {
    ...
    private void init(AttributeSet attrs) {
        if(attrs!=null) {
            ...
            // 捕捉焦点后，下划线的初始颜色
            preLineColor = array.getColor(R.styleable.MyTextView_preLineColor, getResources().getColor(R.color.colorMain));
            // 标签文字的颜色
            labelColor = array.getColor(R.styleable.MyTextView_labelColor, getResources().getColor(R.color.colorMain));
            // 标签文字的内容
